...
class FirmprofilesFilterBody(object):
    ...
    def __init__(self, id=None, firm_id=None, account_access_level=None):  # noqa: E501
        """FirmprofilesFilterBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._firm_id = None
    ...
    @property
    def id(self):
        """Gets the id of this FirmprofilesFilterBody.  # noqa: E501

        Unique ID for this user object  # noqa: E501

        :return: The id of this FirmprofilesFilterBody.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this FirmprofilesFilterBody.

        Unique ID for this user object  # noqa: E501

        :param id: The id of this FirmprofilesFilterBody.  # noqa: E501
        :type: int
        """
    ...
    @property
    def firm_id(self):
        """Gets the firm_id of this FirmprofilesFilterBody.  # noqa: E501

        ID of the owning firm  # noqa: E501

        :return: The firm_id of this FirmprofilesFilterBody.  # noqa: E501
        :rtype: int
        """
    ...
    def firm_id(self, firm_id):
        """Sets the firm_id of this FirmprofilesFilterBody.

        ID of the owning firm  # noqa: E501

        :param firm_id: The firm_id of this FirmprofilesFilterBody.  # noqa: E501
        :type: int
        """
    ...
    def account_access_level(self):
        """Gets the account_access_level of this FirmprofilesFilterBody.  # noqa: E501
        ...
        :return: The account_access_level of this FirmprofilesFilterBody.  # noqa: E501
        :rtype: str
        """
    ...
    def account_access_level(self, account_access_level):
        """Sets the account_access_level of this FirmprofilesFilterBody.

        The user's accessibility level with respect to accounts; can either have access to all accounts or be limited to a subset of them. Can either be all or limited.  # noqa: E501

        :param account_access_level: The account_access_level of this FirmprofilesFilterBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FirmprofilesFilterBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FirmprofilesFilterBody):
            return False
