...
class Coefficient(object):
    ...
    def __init__(self, id=None, mac=None, weight=None, class_tag_id=None, negative_tolerance=None, positive_tolerance=None):  # noqa: E501
        """Coefficient - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._mac = None
        self._weight = None
    ...
    @property
    def id(self):
        """Gets the id of this Coefficient.  # noqa: E501

        Unique ID for this target allocation coefficient object  # noqa: E501

        :return: The id of this Coefficient.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this Coefficient.

        Unique ID for this target allocation coefficient object  # noqa: E501

        :param id: The id of this Coefficient.  # noqa: E501
        :type: int
        """
    ...
    @property
    def mac(self):
        """Gets the mac of this Coefficient.  # noqa: E501

        Master asset class associated with this coefficient  # noqa: E501

        :return: The mac of this Coefficient.  # noqa: E501
        :rtype: int
        """
        return self._mac
    ...
    @mac.setter
    def mac(self, mac):
        """Sets the mac of this Coefficient.

        Master asset class associated with this coefficient  # noqa: E501

        :param mac: The mac of this Coefficient.  # noqa: E501
        :type: int
        """
    ...
    @property
    def weight(self):
        """Gets the weight of this Coefficient.  # noqa: E501

        Weight of the coefficient  # noqa: E501

        :return: The weight of this Coefficient.  # noqa: E501
        :rtype: float
        """
        return self._weight
    ...
    def weight(self, weight):
        """Sets the weight of this Coefficient.

        Weight of the coefficient  # noqa: E501

        :param weight: The weight of this Coefficient.  # noqa: E501
        :type: float
        """
    ...
    def class_tag_id(self):
        """Gets the class_tag_id of this Coefficient.  # noqa: E501

        Asset classification tag id associated with the coefficient  # noqa: E501

        :return: The class_tag_id of this Coefficient.  # noqa: E501
        :rtype: int
        """
    ...
    def class_tag_id(self, class_tag_id):
        """Sets the class_tag_id of this Coefficient.

        Asset classification tag id associated with the coefficient  # noqa: E501

        :param class_tag_id: The class_tag_id of this Coefficient.  # noqa: E501
        :type: int
        """
    ...
    def negative_tolerance(self):
        """Gets the negative_tolerance of this Coefficient.  # noqa: E501

        Value of negative tolerance  # noqa: E501

        :return: The negative_tolerance of this Coefficient.  # noqa: E501
        :rtype: float
        """
    ...
    def negative_tolerance(self, negative_tolerance):
        """Sets the negative_tolerance of this Coefficient.

        Value of negative tolerance  # noqa: E501

        :param negative_tolerance: The negative_tolerance of this Coefficient.  # noqa: E501
        :type: float
        """
    ...
    def positive_tolerance(self):
        """Gets the positive_tolerance of this Coefficient.  # noqa: E501

        Value of positive tolerance  # noqa: E501

        :return: The positive_tolerance of this Coefficient.  # noqa: E501
        :rtype: float
        """
    ...
    def positive_tolerance(self, positive_tolerance):
        """Sets the positive_tolerance of this Coefficient.

        Value of positive tolerance  # noqa: E501

        :param positive_tolerance: The positive_tolerance of this Coefficient.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Coefficient, dict):
