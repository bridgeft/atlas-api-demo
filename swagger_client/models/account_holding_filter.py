...
class AccountHoldingFilter(object):
    ...
    def __init__(self, id=None, as_of_date=None, security_id=None, account_id=None, household_id=None, direction=None, first_open_date=None, first_origination_date=None, latest_open_date=None, abs_units=None, appraised_unit_price=None, abs_beginning_value=None, realized_gain_loss=None, cost_basis_known=None):  # noqa: E501
        """AccountHoldingFilter - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this AccountHoldingFilter.  # noqa: E501

        The unique resource ID for this Holdings object  # noqa: E501

        :return: The id of this AccountHoldingFilter.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this AccountHoldingFilter.

        The unique resource ID for this Holdings object  # noqa: E501

        :param id: The id of this AccountHoldingFilter.  # noqa: E501
        :type: int
        """
    ...
    @property
    def as_of_date(self):
        """Gets the as_of_date of this AccountHoldingFilter.  # noqa: E501

        The current date for this Holding  # noqa: E501

        :return: The as_of_date of this AccountHoldingFilter.  # noqa: E501
        :rtype: datetime
        """
    ...
    def as_of_date(self, as_of_date):
        """Sets the as_of_date of this AccountHoldingFilter.

        The current date for this Holding  # noqa: E501

        :param as_of_date: The as_of_date of this AccountHoldingFilter.  # noqa: E501
        :type: datetime
        """
    ...
    def security_id(self):
        """Gets the security_id of this AccountHoldingFilter.  # noqa: E501

        The id of the Security associated with this Holding  # noqa: E501

        :return: The security_id of this AccountHoldingFilter.  # noqa: E501
        :rtype: int
        """
    ...
    def security_id(self, security_id):
        """Sets the security_id of this AccountHoldingFilter.

        The id of the Security associated with this Holding  # noqa: E501

        :param security_id: The security_id of this AccountHoldingFilter.  # noqa: E501
        :type: int
        """
    ...
    @property
    def account_id(self):
        """Gets the account_id of this AccountHoldingFilter.  # noqa: E501

        The id of the Account associated with this Holding  # noqa: E501

        :return: The account_id of this AccountHoldingFilter.  # noqa: E501
        :rtype: int
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this AccountHoldingFilter.

        The id of the Account associated with this Holding  # noqa: E501

        :param account_id: The account_id of this AccountHoldingFilter.  # noqa: E501
        :type: int
        """
    ...
    def household_id(self):
        """Gets the household_id of this AccountHoldingFilter.  # noqa: E501

        The id of the Household associated with this Holding  # noqa: E501

        :return: The household_id of this AccountHoldingFilter.  # noqa: E501
        :rtype: int
        """
    ...
    def household_id(self, household_id):
        """Sets the household_id of this AccountHoldingFilter.

        The id of the Household associated with this Holding  # noqa: E501

        :param household_id: The household_id of this AccountHoldingFilter.  # noqa: E501
        :type: int
        """
    ...
    @property
    def direction(self):
        """Gets the direction of this AccountHoldingFilter.  # noqa: E501

        Flag to indicate if Holding is Long or Short. Potential values, L = Long, S = Short  # noqa: E501

        :return: The direction of this AccountHoldingFilter.  # noqa: E501
        :rtype: str
        """
    ...
    def direction(self, direction):
        """Sets the direction of this AccountHoldingFilter.

        Flag to indicate if Holding is Long or Short. Potential values, L = Long, S = Short  # noqa: E501

        :param direction: The direction of this AccountHoldingFilter.  # noqa: E501
        :type: str
        """
    ...
    def first_open_date(self):
        """Gets the first_open_date of this AccountHoldingFilter.  # noqa: E501
        ...
        :return: The first_open_date of this AccountHoldingFilter.  # noqa: E501
        :rtype: datetime
        """
    ...
    def first_open_date(self, first_open_date):
        """Sets the first_open_date of this AccountHoldingFilter.

        The original open date for the holding - this represents the earliest cost basis date available at the custodian. Note that this field may be populated with the special date value \"\"1900-01-01\"\" which is to be understood as the absence of cost basis information for at least one of the component positions in this holding  # noqa: E501

        :param first_open_date: The first_open_date of this AccountHoldingFilter.  # noqa: E501
        :type: datetime
        """
    ...
    def first_origination_date(self):
        """Gets the first_origination_date of this AccountHoldingFilter.  # noqa: E501
        ...
        :return: The first_origination_date of this AccountHoldingFilter.  # noqa: E501
        :rtype: datetime
        """
    ...
    def first_origination_date(self, first_origination_date):
        """Sets the first_origination_date of this AccountHoldingFilter.

        The earliest origination date for the holding - this represents the earliest cost basis date available at the custodian in all time even for shares originated outside the account. Note that this field may be populated with the special date value \"\"1900-01-01\"\" which is to be understood as the absence of cost basis information for at least one of the component positions in this holding  # noqa: E501

        :param first_origination_date: The first_origination_date of this AccountHoldingFilter.  # noqa: E501
        :type: datetime
        """
    ...
    def latest_open_date(self):
        """Gets the latest_open_date of this AccountHoldingFilter.  # noqa: E501
        ...
        :return: The latest_open_date of this AccountHoldingFilter.  # noqa: E501
        :rtype: datetime
        """
    ...
    def latest_open_date(self, latest_open_date):
        """Sets the latest_open_date of this AccountHoldingFilter.

        The most recent date for opening lots (e.g. last time more shares were purchased). Note that this field may be populated with the special date value \"\"1900-01-01\"\" which is to be understood as the absence of cost basis information for all of the component positions in this holding  # noqa: E501

        :param latest_open_date: The latest_open_date of this AccountHoldingFilter.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def abs_units(self):
        """Gets the abs_units of this AccountHoldingFilter.  # noqa: E501

        Quantity of shares for the holding - combine with direction to know if the position is long or short  # noqa: E501

        :return: The abs_units of this AccountHoldingFilter.  # noqa: E501
        :rtype: float
        """
    ...
    def abs_units(self, abs_units):
        """Sets the abs_units of this AccountHoldingFilter.

        Quantity of shares for the holding - combine with direction to know if the position is long or short  # noqa: E501

        :param abs_units: The abs_units of this AccountHoldingFilter.  # noqa: E501
        :type: float
        """
    ...
    def appraised_unit_price(self):
        """Gets the appraised_unit_price of this AccountHoldingFilter.  # noqa: E501

        Market price of security on as_of_date  # noqa: E501

        :return: The appraised_unit_price of this AccountHoldingFilter.  # noqa: E501
        :rtype: float
        """
    ...
    def appraised_unit_price(self, appraised_unit_price):
        """Sets the appraised_unit_price of this AccountHoldingFilter.

        Market price of security on as_of_date  # noqa: E501

        :param appraised_unit_price: The appraised_unit_price of this AccountHoldingFilter.  # noqa: E501
        :type: float
        """
    ...
    def abs_beginning_value(self):
        """Gets the abs_beginning_value of this AccountHoldingFilter.  # noqa: E501

        Cost basis of the units  # noqa: E501

        :return: The abs_beginning_value of this AccountHoldingFilter.  # noqa: E501
        :rtype: float
        """
    ...
    def abs_beginning_value(self, abs_beginning_value):
        """Sets the abs_beginning_value of this AccountHoldingFilter.

        Cost basis of the units  # noqa: E501

        :param abs_beginning_value: The abs_beginning_value of this AccountHoldingFilter.  # noqa: E501
        :type: float
        """
    ...
    def realized_gain_loss(self):
        """Gets the realized_gain_loss of this AccountHoldingFilter.  # noqa: E501

        Aggregates from Gain Loss end point; dollar gain or loss from trade activity  # noqa: E501

        :return: The realized_gain_loss of this AccountHoldingFilter.  # noqa: E501
        :rtype: float
        """
    ...
    def realized_gain_loss(self, realized_gain_loss):
        """Sets the realized_gain_loss of this AccountHoldingFilter.

        Aggregates from Gain Loss end point; dollar gain or loss from trade activity  # noqa: E501

        :param realized_gain_loss: The realized_gain_loss of this AccountHoldingFilter.  # noqa: E501
        :type: float
        """
    ...
    def cost_basis_known(self):
        """Gets the cost_basis_known of this AccountHoldingFilter.  # noqa: E501

        Is the cost basis known for this holding?  # noqa: E501

        :return: The cost_basis_known of this AccountHoldingFilter.  # noqa: E501
        :rtype: bool
        """
    ...
    def cost_basis_known(self, cost_basis_known):
        """Sets the cost_basis_known of this AccountHoldingFilter.

        Is the cost basis known for this holding?  # noqa: E501

        :param cost_basis_known: The cost_basis_known of this AccountHoldingFilter.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccountHoldingFilter, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountHoldingFilter):
            return False
