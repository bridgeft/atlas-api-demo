...
class GroupAssignment(object):
    ...
    @property
    def id(self):
        """Gets the id of this GroupAssignment.  # noqa: E501

        The unique resource id for this Account Group Assignment  # noqa: E501

        :return: The id of this GroupAssignment.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GroupAssignment.

        The unique resource id for this Account Group Assignment  # noqa: E501

        :param id: The id of this GroupAssignment.  # noqa: E501
        :type: int
        """
    ...
    @property
    def account_id(self):
        """Gets the account_id of this GroupAssignment.  # noqa: E501

        The related account of this assignment  # noqa: E501

        :return: The account_id of this GroupAssignment.  # noqa: E501
        :rtype: int
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this GroupAssignment.

        The related account of this assignment  # noqa: E501

        :param account_id: The account_id of this GroupAssignment.  # noqa: E501
        :type: int
        """
    ...
    @property
    def group_id(self):
        """Gets the group_id of this GroupAssignment.  # noqa: E501

        The related group of this assignment  # noqa: E501

        :return: The group_id of this GroupAssignment.  # noqa: E501
        :rtype: int
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this GroupAssignment.

        The related group of this assignment  # noqa: E501

        :param group_id: The group_id of this GroupAssignment.  # noqa: E501
        :type: int
        """
    ...
    def fee_location(self):
        """Gets the fee_location of this GroupAssignment.  # noqa: E501
        ...
        :return: The fee_location of this GroupAssignment.  # noqa: E501
        :rtype: int
        """
    ...
    def fee_location(self, fee_location):
        """Sets the fee_location of this GroupAssignment.

        Numerical indicator for fee location behavior. Options are 0 (charged to itself), -1 (uncharged / charged to the group, where fees are distributed in prorate fashion by size), or a positive integer, which represents the ID of the account being charged.  # noqa: E501

        :param fee_location: The fee_location of this GroupAssignment.  # noqa: E501
        :type: int
        """
    ...
    def fee_location_option(self):
        """Gets the fee_location_option of this GroupAssignment.  # noqa: E501

        The desired fee location option. Options are S (self), G (group), or A (account).  # noqa: E501

        :return: The fee_location_option of this GroupAssignment.  # noqa: E501
        :rtype: str
        """
    ...
    def fee_location_option(self, fee_location_option):
        """Sets the fee_location_option of this GroupAssignment.

        The desired fee location option. Options are S (self), G (group), or A (account).  # noqa: E501

        :param fee_location_option: The fee_location_option of this GroupAssignment.  # noqa: E501
        :type: str
        """
